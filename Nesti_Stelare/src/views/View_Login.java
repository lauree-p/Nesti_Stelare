...
public class View_Login {
	...
	private void initialize() {
		...
		name_user.setBounds(21, 170, 157, 14);
		...
		passWord_user.setBounds(21, 248, 146, 14);
		frame.getContentPane().add(passWord_user);

		name = new JTextField();
		name.setBounds(169, 163, 356, 33);
		frame.getContentPane().add(name);
		name.setColumns(10);

		passWord = new JTextField();
		passWord.setBounds(169, 241, 356, 33);
		...
		btn_connection.setBounds(204, 306, 157, 33);
